    ...
    >
      ...
      >
        ...
        <div className="relative p-4 sm:p-6 border-b border-ink-border bg-ink-surface/70 flex items-start justify-between gap-3 sm:gap-4">
          ...
          <div className="relative z-10">
            <div className="flex items-center gap-2 text-gold font-mono text-[10px] tracking-widest uppercase mb-1">
              <span>{isArabic ? "أرشيف كايرو الرسمي" : "MANGA WORLD ARCHIVE CODEX"}</span>
              <span>/</span>
            ...
            <div className="space-y-6 animate-in fade-in duration-150">
              <div className="p-5 bg-ink-surface border-2 border-gold/30 rounded-xs relative">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-ink-border pb-3 mb-4">
                  ...
                  {/* Official MANGA WORLD Japanese Collector Hanko Seal */}
                ...
                <p className="text-paper mb-3">
                  {isArabic
                    ...
                    : "This document certifies that every volume distributed through MANGA WORLD Publishing Archive is imported directly from official licensed rights holders, including Shueisha, Kodansha, Hakusensha, Shogakukan, Square Enix, and authorized Western imprints (Dark Horse, Viz Media)."}
                </p>
              ...
              <div className="p-4 bg-ink-surface border border-ink-border rounded-xs">
                ...
                <p className="text-paper">
                  {isArabic
                    ...
                    : "Your privacy is paramount. MANGA WORLD adheres to strict data minimization standards and the Egyptian Data Protection Law (Law No. 151 of 2020)."}
                </p>
              </div>
              ...
              <div className="p-4 bg-ink-surface border border-ink-border rounded-xs">
                ...
                <p className="text-paper">
                  {isArabic
                    ...
                    : "By placing an order on MANGA WORLD, you agree to the following terms designed to ensure collector satisfaction across Egypt."}
                </p>
              </div>
        ...
        <div className="p-4 border-t border-ink-border bg-ink-surface/80 flex items-center justify-between text-[11px] font-mono">
          <span className="text-gold font-serif">物語と記憶のかたち • MANGA WORLD OFFICIAL ARCHIVE</span>
          <button
            onClick={onClose}

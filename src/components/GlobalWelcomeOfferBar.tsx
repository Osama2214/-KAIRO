    ...
    >
      <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-2.5 sm:gap-4 text-xs font-mono">
        ...
        <div className="flex items-center gap-2 sm:gap-3 text-center sm:text-left flex-wrap justify-center sm:justify-start">
          ...
          <p className="text-paper-muted leading-tight text-[11px] sm:text-xs">
        ...
        <div className="flex items-center gap-2 sm:gap-3 shrink-0">
          ...
          {timeLeft && (
            <div className="flex items-center gap-1.5 text-text-muted text-[11px]">
              ...
              <span className="text-[10px] text-text-muted hidden md:inline">ENDS IN:</span>
          ...
          <button
            type="button"
            onClick={handleApplyOffer}
            className={`px-3 py-1 text-[11px] uppercase tracking-wider font-bold rounded-xs transition-all flex items-center gap-1.5 cursor-pointer shadow-xs shrink-0 ${
              copied || isApplied
